...
At the end of the this hands-on project, you will be able to;
...
- The commented part directly uses the local hostpath for storage. you can try it on their own later.
